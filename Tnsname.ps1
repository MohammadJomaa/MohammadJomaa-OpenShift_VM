 [string] $Name = Get-Content D:/TNS_Name -Raw
 [string] $Protocol = Get-Content D:/TNS_Protocol  -Raw
 [string] $Hostname = Get-Content D:/TNS_Hostname  -Raw
 [string] $Port = Get-Content D:/TNS_Port -Raw
 [string] $Sid= Get-Content D:/TNS_Sid  -Raw
 [System.IO.FileInfo] $File= Get-Content D:/TNS_File  -Raw
